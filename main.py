...
if __name__ == "__main__":
    ...
    duo_authenticator = DuoAuthenticator.DuoAuthenticator(s, login_hook, verbose=True)
    r = duo_authenticator.session.get("https://25live.collegenet.com/25live/data/uc/run/login.shibboleth")
    print(r.text)
